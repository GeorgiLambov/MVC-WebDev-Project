    ...
    <nav class="navbar navbar-default col-lg-12 col-sm-12 col-xs-12">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                <form class="navbar-form  col-lg-12 col-sm-6 col-xs-6" role="search" action="/posts/index" method="post">
        ...
        <?php if(isset($_SESSION['messages'])): ?>
            <?php if($_SESSION['messages']['type'] == 'error'): ?>
                <div class="alert alert-dismissible alert-danger col-lg-12 col-sm-10 col-xs-10">
                    <button type="button" class="close" data-dismiss="alert">×</button>
                    <strong><?php echo $_SESSION['messages']['text']; ?></strong>
                </div>
            <?php endif; ?>
            <?php if($_SESSION['messages']['type'] == 'info'): ?>
                <div class="alert alert-dismissible alert-success col-lg-12 col-sm-10 col-xs-10">
                    <button type="button" class="close" data-dismiss="alert">×</button>
                    <strong><?php echo $_SESSION['messages']['text']; ?></strong>
                </div>
            <?php endif; ?>
